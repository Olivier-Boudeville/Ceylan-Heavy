...
# and then the OS-specific one, if available.
# ex : .bashrc.Linux, .bashrc.SunOS, etc.
# An initial host-related hook is provided as well.


# Retrieve the directory where this file and its helper files are stored :
MYHOME=$HOME
