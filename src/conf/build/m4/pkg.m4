...
# If pkg-config is available on the platform on which autogen.sh
# is run (hence there is already an available pkg.m4), no error is reported,
...
# Here is the real beginning of pkg.m4 (version 0.19) :
