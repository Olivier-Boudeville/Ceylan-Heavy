...
/*
 * The file CeylanHeaderVersion.cc is generated from 
 * CeylanHeaderVersion.cc.in, so that the embedded library version can be
 * automatically updated whenever appropriate.
 *
 * @note This file should not be check-ined if updated by the configure script :
 * if you do not see the value "CEYLAN_LIBTOOL_VERSION" surrounded by '@' 
...
/*
 * @note Do not ckeck-in this file if there is no '@' in the variable value, 
