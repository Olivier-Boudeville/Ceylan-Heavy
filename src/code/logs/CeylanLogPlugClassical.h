	...
	namespace Log
	{
		...
		class CEYLAN_DLL LogPlugClassical : public LogPlug
		{
			...
			public:
				 ...
				 *
				 * @param immediateWrite tells whether the classical aggregator
				 * should store messages as soon as they arrive, or wait till
				 * asked before aggregating them.
				 *
				 * @param smart tells whether the classical aggregator should be
				 * smart.
				 *
			...
			private:
				...
				LogPlugClassical() __attribute__ ((noreturn)) ;
