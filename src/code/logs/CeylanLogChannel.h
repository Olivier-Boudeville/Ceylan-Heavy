...
namespace Ceylan
{
	...
	namespace Log
	{
		...
		/**
		 * Log channels are thematic containers for log messages, meant to be
		 * used by LogAggregators.
		 *
		 * @see LogAggregator
		 *
		 */
		class CEYLAN_DLL LogChannel : public TextDisplayable
		{
			...
			public:
				 ...
				 *
				 * @note This method takes ownership of the specified log
				 * message.
				 *
				 * @param message the log message to record
				 *
				 * @param check if true, raises a LogException if this added
				 * message's channel does not match this channel.
				 *
				...
				/**
				 * Returns the number of messages this channel currently
				 * gathered.
				 *
				 */
