...
/**
 * This is the place where HTML fragments for LogAggregatorHTML templates should
 * be stored.
 *
 * @see LogAggregatorHTML
 *
 * @note This header is meant to be included only once, by
 * CeylanLogAggregatorHTML.cc, otherwise its symbols would be defined multiple
 * times.
 *
 */
