	...
	namespace System
	{
		...
		class CEYLAN_DLL OutputStream : public virtual Stream
		{
			...
			public:
				...
				/**
				 * Exception thrown when an operation on an OutputStream failed.
				 *
				 */
				 ...
				 * implementation just throws a WriteFailedException to remember
				 ...
				 * written. Its size must be at least 'length' bytes.
				 *
				 ...
				 *
				 * @note Written strings cannot have more than 65535 characters.
				 *
