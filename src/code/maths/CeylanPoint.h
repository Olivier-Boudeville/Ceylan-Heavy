...
namespace Ceylan
{
	...
	namespace Maths
	{
		...
		namespace Linear
		{
			 ...
			 *
			 * Points and vectors are basically the same beasts, except they can mean different
			 * things to the developer. The Vector class is more versatile.
			 *
			 ...
			 * but it would not be overloaded by child classes. Even from a Matrix3, lines such as
			 * 'for ( MatrixIndex i = 0 ; i < Dimensions ; i++ )'  would use Matrix::Dimensions,
			 * and not Matrix3::Dimensions. A solution could be to define a getDimensions method.
			...
			class Point : public TextDisplayable
			{
				...
				public:
					 ...
					 *
					 * @note An emergency shutdown is triggered if index is out of bounds.
					 *
					 */
					virtual Real getElementAt( MatrixIndex index ) const throw() = 0 ;
					 ...
					 *
					 */
					virtual void setElementAt( MatrixIndex index, Real newValue ) throw() = 0 ;
