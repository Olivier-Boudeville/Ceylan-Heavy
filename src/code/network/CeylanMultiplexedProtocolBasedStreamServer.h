...
namespace Ceylan
{
	...
	namespace Network
	{
		 ...
		 * (see AnonymousProtocolAwareStreamSocket::setProtocolServer)
		 *
		 *
			...
			public MultiplexedServerStreamSocket
		{
			...
			public:
				 ...
				 * }
				 *
				 * @note This method must be overriden, and must set a 
				 * protocol server for the given 
				 * AnonymousProtocolAwareStreamSocket instance.
				 *.
				 *
				 ...
				 * protocol-based socket in charge of this connection that 
				 * has data to be read. It is actually an
				 * AnonymousProtocolAwareStreamSocket instance.
				 *
				 ...
				 * called by the multiplexed server, the stream is selected,
				 * i.e. has already data available for reading. 
				 * This data may be interpreted by the protocol server of the 
				 * connection socket as a request that can be decoded,
