	...
	namespace Network
	{
		...
		class CEYLAN_DLL StreamSocket : public Socket
		{
			...
			public:
				 ...
				 *
				 * @param sacrificeThroughputToPacketTiming tells whether the
				 * snappiest possible response (packet timing) should be
				 ...
				 * recommended except for remote GUI or multiplayer network
				 * games. Hence the default is false, and the Nagle algorithm is
				 * used.
				 *
				 * @see
			...
			protected:
				 ...
				 *
				 * @param activated if true, activates the algorithm, if false,
				 * deactivates it.
				 *
				 * By default the Nagle algorithm is activated, as it should be
				 * used on most situations.
				 *
				 */
				 ...
				 * deactivated, so that the snappiest possible response (packet
				 * timing) is searched for (if true), even though it would be
				 * obtained at the expense of usable network bandwidth.
				 *
