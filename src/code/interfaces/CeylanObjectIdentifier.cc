	...
	const
{
	...
	/*
	 * If addresses or other required fields do not match, they are trivially
	 * different:
	 *
	 */
	...
	/*
	 * Equality of classnames: identifiers match but are strictly the same, so
	 * return false:
	 *
	 */
	...
	const string & channelName )
{
	...
	/*
	 * Let's try to extract the meaningful fields of this compacted channel
	 * name.
	 *
	 */
	...
	/*
	 * Disabled at the moment, pattern matching is to be used on subelements
	 * only:
	 *
