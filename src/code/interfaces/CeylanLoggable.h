	...
	namespace Log
	{
		...
		class CEYLAN_DLL Loggable : public LogSource
		{
			...
			public:
				 ...
				 *
				 *
				 * @param name the name of the Loggable which will be used 
				 * for its private channel.
				 *
				 ...
				 * channel name, based on the possible presence of the 
				 * protocol prefix and separators (typically, loggable://).
				 *
				 */
				...
				/**
				 * Returns the real channel name used by a Loggable by 
				 * removing the protocol prefix and separators (typically,
				 * 'loggable://').
				 *
				 */
