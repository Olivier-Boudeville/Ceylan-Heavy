...
int main( int argc, char * argv[] )
{
   ...
   <para color="brown" height="200" width="100">
       ...
       <c_ex height="7.1">
 			...
 			*
 			* However the f_ex solo tag was not added, as if the Ceylan parser
			* is able to read it indeed, it would be written as 
			* '<f_ex comment="I am a solo tag"></f_ex>', which would make the
			* diff fail, short of finding in written file the original solo
			* mark-up.
			*
    		*/
			...
			/*
			 * Not an automatic variable, as the markup will be owned by 
			 * the tree:
			 *
			 */
			...
			/*
			 * Not an automatic variable, as the tree will be owned by 
			 * the parser:
			 *
			 */
			...
			/* 
			 * Not an automatic variable, as the markup will be owned 
			 * by the tree:
			 *
			 */
