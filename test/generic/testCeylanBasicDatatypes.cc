...
int main( int argc, char * argv[] )
{

  {
	...
	try
	{
	  ...
	  /*
	   * 8-bit datatypes have to be cast to wider types to avoid mismatch with
	   * char-based toString methods, and because toNumericalString is for
	   * unsigned data only.
	   *
	   */
	  ...
	  LogPlug::info( "Size of Ceylan::LongFloat is "
		...
		"may be incorrectly displayed, see the frame source if needed." ) ;
