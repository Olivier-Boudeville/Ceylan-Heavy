...
int main( int argc, char * argv[] )
{
    ...
    try
    {
		...
		v3 = v1 - v2 ;
		LogPlug::info( "Substract : v1 - v2 = " + v3.toString() ) ;
			
		if ( v3 != Vector3( 2, -3, 8 ) )
			throw Ceylan::TestException( "Substraction of Vector3 failed." ) ;
		...
		t2 = t1 - v2 ;
		LogPlug::info( "Substract : t1 - v2 " + v2.toString() 
			+  " = " + t2.toString() ) ;
			
		if ( t2 != Tripoint( 2, -3, 8 ) )
			throw Ceylan::TestException( 
				"Substraction Tripoint minus Vector3 failed." ) ;
