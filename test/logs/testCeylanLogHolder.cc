...
int main( int argc, char * argv[] )
{

  {
	...
	try
	{
	  ...
	  cout << endl << "End of LogHolder test." << endl << std::flush ;


	  /*
	   * One can test by uncommenting the next line that even if an exception is
	   * raised, Log system is correctly shut down.
	   *
